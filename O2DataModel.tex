...
The \O2 message consists of a sequence of metadata-payload pairs referenced from a multi-part message vector as illustrated in figure \ref{fig:o2message}.
